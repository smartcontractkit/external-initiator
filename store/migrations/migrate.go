...
import (
	...
	"github.com/smartcontractkit/external-initiator/store/migrations/migration1619131378"
...
func Migrate(db *gorm.DB) error {
	...
	migrations := []*gormigrate.Migration{
		...
		{
			ID:       "1619131378",
			Migrate:  migration1619131378.Migrate,
			Rollback: migration1619131378.Rollback,
		},
	}
